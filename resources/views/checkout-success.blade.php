...
<head>
    <meta charset="UTF-8">
    <title>Sikeres Vásárlás - G3X</title>
...
<body style="min-height: 100vh; background: linear-gradient(135deg, #0b1c2c 0%, #1a3a52 100%); padding: 120px 20px 40px 20px;">
    ...
    <nav class="navbar">
        <div class="navbar-top">
            ...
            <div class="nav-right">
                ...
                @endauth
                <a href="{{ route('cart.index') }}" class="nav-btn">🛒 Kosár</a>
            </div>
        </div>
    </nav>
    ...
    <div class="success-container">
        <div style="margin-bottom: 30px;">
            <h2 style="color: #00ff99; margin: 0;">✅ Sikeres Vásárlás!</h2>
        </div>
        <p style="color: #cccccc; margin-bottom: 30px;">Köszönjük a megrendelést! Az aktiválási kulcsokat lentebb találod.</p>
        ...
        <div class="success-info">
            ...
            <div class="info-row">
                <span class="info-label">💰 Összes ár:</span>
                <span class="info-value">{{ number_format($total, 0, ',', ' ') }} Ft</span>
            </div>
            <div class="info-row">
                <span class="info-label">🎮 Termékek száma:</span>
            ...
            <div class="info-row">
                ...
                <span class="info-value">{{ $paymentMethods[$payment_method] ?? 'Ismeretlen' }}</span>
            </div>
        </div>

        <div class="licenses-section">
            <h2>🔑 Az ön aktiválási kulcsai</h2>
        ...
        <div class="email-note">
            ℹ️ Az összes aktiválási kulcs és a számla is el lett küldve az {{ $email }} címre. Az e-mailben egy letölthető PDF-et is megtalálsz az összes kulccsal, számla adatokkal és további részletekkel.
        </div>

        <div class="action-buttons">
            <a href="{{ route('home') }}" class="btn-primary">🏠 Vissza a főoldalra</a>
            <a href="{{ route('cart.index') }}" class="btn-secondary">🛒 Vissza a Kosárhoz</a>
        </div>
    </div>
