...
<body>
    ...
    <div id="sidebar" class="sidebar">
        ...
        <h3>Kategóriák</h3>
        <ul>
            <li><a href="{{ route('filter.show', 'pc-games') }}">🖥️ PC játékok</a></li>
            <li><a href="{{ route('filter.show', 'console-games') }}">🎮 Konzol Játékok</a></li>
            <li><a href="{{ route('filter.show', 'game-subscriptions') }}">🎯 Játék Előfizetések</a></li>
                    ...
                    <div class="product-card" style="cursor: pointer;" onclick="localStorage.setItem('lastSearchUrl', window.location.href); localStorage.removeItem('lastFilterUrl'); window.location.href='{{ route('product.show', $product->id) }}'">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-footer">
                                <span class="product-price">{{ number_format($minPrice, 0, ',', ' ') }} Ft-tól</span>
                                <button onclick="event.stopPropagation(); addToCart({{ $product->id }})" class="btn-add-cart">Hozzáadás</button>
                            </div>
                        </div>
                    </div>
                @endforeach
