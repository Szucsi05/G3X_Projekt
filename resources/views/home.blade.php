...
<head>
    ...
    <style>
        ...
        .product-card:hover {
            ...
            box-shadow: 0 12px 35px rgba(0, 255, 153, 0.2);
        }
                ...
                <div class="product-card" onclick="goToProduct({{ $product->id }})" style="cursor: pointer;">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-footer">
                            <span class="product-price">{{ number_format($firstPrice, 0, ',', '.') }} Ft</span>
                            <button type="button" class="btn-add-cart" onclick="event.stopPropagation(); addToCart({{ $product->id }})">Hozzáadás</button>
                        </div>
                    </div>
                </div>
            @endforeach
